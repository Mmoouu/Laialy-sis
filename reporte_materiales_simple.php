...
//////////////////////////////////////////////////////////////////////////////////////////////////
$reporte_materiales_simple = ""; 
//////////////////////////////////////////////////////////////////////////////////////////////////
if(isset($_GET['nav'])){
    $nav = $_GET['nav'];    
    if ($nav == "reporte_materiales_simple"){
        $titulo_sisint = "Reporte de Insumos";
        $reporte_materiales_simple = "active";
    ...
    <div id="columna_costos"> 
        <form class="form_costos" name="form_costos" action="" method="get" enctype="multipart/form-data">   
            ...
            <div class='radio_input'> 
                <input type='radio' name='marca' value='materiales_laialy' required <?php echo $checked_laialy; ?> />                       
                <p>Laialy</p>
            </div>
            <br><br>
            <button class="last_costos" name="nav" value="reporte_materiales_simple"><p>Listar</p></button>
        </form>
    </div>
