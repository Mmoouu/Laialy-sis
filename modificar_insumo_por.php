...
<section>
    ...
    $consulta_insumo_bk_color = utf8_decode($listado_de_insumos['color']);
    ...
    <div id="nuevo_ingreso">
        ...
        <form class="fomulario_nuevo_ingreso" name="formulario_nuevo_ingreso" action="" method="post" enctype="multipart/form-data">
            ...
            <div class="fneworder_dos">
                ...
                <input type="text" name="color" value="<?php echo $consulta_insumo_bk_color; ?>" readonly/> 
            </div>
            <div class="fneworder">
            ...
            <div class="fneworder_dos last_item">
                ...
                <input type="number" step="0.001" name="incremento" value="" required/>
            </div> 
        ...
        <?php      
            if (isset($_POST['submit'])){
                ...
                $form_incremento = $_POST['incremento'];
                $form_dia_mod = date("d");
                $form_mes_mod = date("m");
                $form_anio_mod = date("y");
                $form_hora_mod = date('His'); 
                
                if ($form_incremento !== "Ingresar un Valor"){                    
                
                    require("../conexion.laialy.php");
                    
                    $porcentaje = ($consulta_insumo_bk_valor*$form_incremento)/100;
                    $valor_final = $consulta_insumo_bk_valor+$porcentaje;
                    $valor_final_formateado = number_format($valor_final,3,'.','');
                    
                    mysqli_query($conexion, "UPDATE $nav SET valor='$valor_final_formateado', dia_mod='$form_dia_mod', mes_mod='$form_mes_mod', anio_mod='$form_anio_mod', hora_mod='$form_hora_mod' $where");
                
                    $nueva_fecha = $form_dia_mod."-".$form_mes_mod."-".$form_anio_mod;                    
                    
                    mysqli_query($conexion, "INSERT INTO historial_$nav (id_historial, tipo, id_insumo, cod_ins, insumo, categoria, subcategoria, color, proveedor, valor, aplica, cambio, fecha, fecha_cambio, hora, hora_cambio) VALUES (null,'valor','$get_id_insumo','$consulta_insumo_bk_cod_ins','$consulta_insumo_bk_insumo','$consulta_insumo_bk_categoria','$consulta_insumo_bk_subcategoria','$consulta_insumo_bk_color','$consulta_insumo_bk_proveedor','$consulta_insumo_bk_valor','$form_incremento','$valor_final_formateado','$consulta_insumo_bk_fecha','$nueva_fecha','$consulta_insumo_bk_hora_mod','$form_hora_mod')");
                    ...
                    //////////////////////////////////////////REGISTRO LOG//////////////////////////////////////////////////
                    $log_valor = "Valores ".$porcentaje." %. Valor Final ".$valor_final_formateado;
