...
<section>
    ...
    if(isset($_GET['nav'])){
        ...
        $seleccionar_el_plato = mysqli_query($conexion,  "SELECT * FROM $nav WHERE activo = '1'");
        mysqli_close($conexion);
        while($ver_el_plato = mysqli_fetch_array($seleccionar_el_plato)){
            //////////////////////////////////////////////////////////////////////////////////////////////
            ...
            $plato_por_costo = $ver_los_porcentajes_plato;
            $plato_por_perdidas = $ver_las_perdidas_plato;
            ...
            //$log_accion = "Actualiza platos ".$nav;
            //require("log.php");
            ////////////////////////////////////////////////////////////////////////////////////////////////////////
            
            mysqli_close($conexion);

            //echo "<script language=Javascript> location.href=\"platos.php?nav=$nav&mensaje=plato_actualizado\";</script>"; 
            }
        ...
        echo "<script language=Javascript> location.href=\"platos.php?nav=$nav&mensaje=plato_no_actualizado\";</script>";
    }
    ?>
    </section>
</body>
