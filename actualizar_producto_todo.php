...
<section>
    ...
    if(isset($_GET['nav'])){
        ...
        $seleccionar_el_producto = mysqli_query($conexion,  "SELECT * FROM $nav WHERE activo = '1'");
        mysqli_close($conexion);
        while($ver_el_producto = mysqli_fetch_array($seleccionar_el_producto)){
            //////////////////////////////////////////////////////////////////////////////////////////////
            ...
            $art_sel = $ver_el_producto['id_producto'];
            ...
            while ($ver_los_materiales = mysqli_fetch_array($seleccionar_los_materiales)){
                ...
                for ($in=0; $in<$longitud; $in++){
                    ...
                    while ($ver_los_insumos = mysqli_fetch_array($seleccionar_los_insumos)){
                        $comprobar = ($comprobar + $ver_los_insumos['valor']);                            
                    }                              
                }
                mysqli_close($conexion);
            ...
            $producto_por_costo = $ver_los_porcentajes_producto;
            $producto_por_perdidas = $ver_las_perdidas_producto;
            ...
            //////////////////////////////////////////REGISTRO LOG////////VER////////////////////////////
            //$log_valor = "linea completa";
            //$log_accion = "Actualiza Productos ".$nav;
            //require("log.php");
            ////////////////////////////////////////////////////////////////////////////////////////////////////////
            
            mysqli_close($conexion);

            //echo "<script language=Javascript> location.href=\"productos.php?nav=$nav&mensaje=producto_actualizado\";</script>"; 
            }
        ...
        echo "<script language=Javascript> location.href=\"productos.php?nav=$nav&mensaje=producto_no_actualizado\";</script>";
    }
    ?>
    </section>
</body>
