            ...
            $consulta_de_insumos = mysqli_query($conexion,  "SELECT * FROM insumos_laialy ORDER BY id ASC");
            mysqli_close($conexion);

            if(!$consulta_de_insumos || mysqli_num_rows($consulta_de_insumos) == 0){            
                echo "<div style='width:500px; height:50px; display:block; margin:40px auto; top:0px; left:0px;'><p style='font-family:thin; color:#aaaaaa; text-align:center; font-size:3em;'>No programada la busqueda</p></div>";
            } else {
