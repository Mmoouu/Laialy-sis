...
<div id="columna_2_stock">
    ...
    <div id="desarr_de_stock">
        <form class='fomulario_nuevo_ingreso_col2' action='' method='post' enctype='multipart/form-data'>                                   
            ...
            <button class="stock_button btn_stock_aceptar" onclick="restaStock(document.getElementById('valor_stock').value,document.getElementById('stock_stock').value)">Aceptar</button>
