...
<div id="columna_2_stock">
    <div id="header_de_stock">
        <div id="num_de_stock"><p>Ingreso de Stock</p></div>
    ...
    <div id="desarr_de_stock">
        <form class='fomulario_nuevo_ingreso_col2' action='' method='post' enctype='multipart/form-data'>                                   
            ...
            <div class="stock_button btn_stock_aceptar" onclick="stockMovimientos('<?php echo $accion; ?>','<?php echo $id_insumo; ?>','<?php echo $cod; ?>','<?php echo $insumo; ?>','<?php echo $proveedor; ?>','<?php echo $medida; ?>','<?php echo $valor_insumo; ?>','<?php echo $stock_insumo; ?>',document.getElementById('valor_form').value,document.getElementById('stock_form').value,'adjunto')">Aceptar</div>
