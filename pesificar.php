...
if(isset($_GET['nav'])){
    ...
    if ($nav == "insumos_uss_laialy"){
        $titulo_sisint = "Pesificacion Laialy";
        $insumos_laialy = "active";
    } else if ($nav == "insumos_uss_belen"){
        $titulo_sisint = "Pesificacion Belen";
        $insumos_belen = "active";
    } else if ($nav == "insumos_uss_lara"){
        $titulo_sisint = "Pesificacion Lara Teens";
        $insumos_lara = "active";
    } else if ($nav == "insumos_uss_sigry"){
        $titulo_sisint = "Pesificacion Sigry";
...
if (isset($_GET['dolar']) & isset($_GET['proveedor']) & isset($_GET['iva'])){
    ...
    $dolar_posteado = $_GET['dolar']; 
    $iva_posteado = $_GET['iva'];
    ...
    <div id="nuevo_ingreso">
        ...
        <form class="fomulario_nuevo_ingreso" name="formulario_nuevo_ingreso" action="" method="get" enctype="multipart/form-data">
            <div class="fneworder_dos">
                <label><p>Cotizacion Dolar</p></label>
                <input type="number" step="0.001" value="<?php echo $dolar_posteado; ?>" name="dolar" required/>
            </div>
            <div class="espacio"><p></p></div>
            <div class="fneworder_dos">
                <label><p>Iva</p></label>
                <select type="text" name="iva" required>
                    <option value="<?php echo $iva_posteado; ?>" selected><?php echo $iva_posteado; ?></option>
        ...
        if (isset($_GET['dolar']) & isset($_GET['proveedor']) & isset($_GET['iva'])){
            ...
            ?>
                ...
                <div id="listado_flotante">  
                    <div id="cabecera_flotante">  
                        <h1><?php echo "Dolar: ".$form_dolar." Iva: ".$form_iva." Proveedor: ".$ver_proveedor; ?></h1>
                    </div>
                    <ul id="header_tabla_flotante">
                    ...
                    <div class="para_botones_flotante">
                        <div class="boton_cancela_incremento" onclick="location.href='insumos_uss.php?nav=<?php echo $nav; ?>&mensaje=no_pesificacion&pagina=1'"><p>Cancelar</p></div>
                        <div class="boton_acepta_incremento" onclick="location.href='aplica_pesificacion.php?nav=<?php echo $nav; ?>&dolar=<?php echo $dolar_posteado; ?>&iva=<?php echo $iva_posteado; ?>&proveedor=<?php echo $id_proveedor_posteado; ?>'"><p>Aceptar</p></div>
                    </div>
                </div>
                <?php
                }
