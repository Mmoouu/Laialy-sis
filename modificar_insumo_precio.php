        ...
        <?php      
            if (isset($_POST['submit'])){
                ...
                if ($form_valor !== $consulta_insumo_bk_valor){                    
                    ...
                    mysqli_query($conexion, "INSERT INTO historial_$nav (id_historial, tipo, id_insumo, cod_ins, insumo, categoria, subcategoria, color, proveedor, valor, aplica, cambio, fecha, fecha_cambio, hora, hora_cambio) VALUES (null,'valor','$get_id_insumo','$consulta_insumo_bk_cod_ins','$consulta_insumo_bk_insumo','$consulta_insumo_bk_categoria','$consulta_insumo_bk_subcategoria','$consulta_insumo_bk_color','$consulta_insumo_bk_proveedor','$consulta_insumo_bk_valor','$por_formateado','$form_valor','$consulta_insumo_bk_fecha','$nueva_fecha','$consulta_insumo_bk_hora_mod','$form_hora_mod')");
