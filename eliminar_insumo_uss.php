...
if(isset($_GET['id_insumo']) and isset($_GET['color'])){
...
<section>
    ...
    $consulta_insumo_bk_id_insumo_p = utf8_decode($listado_de_insumos['id_insumo_p']);
    ...
    <div id="nuevo_ingreso">
        ...
        <form class="fomulario_nuevo_ingreso" name="formulario_nuevo_ingreso" action="" method="post" enctype="multipart/form-data">
            ...
            <div class="fneworder_dos">
                ...
                <input type="text" name="color" value="<?php echo $get_color; ?>" readonly/>
            </div>  
            <div class="fneworder_dos">
                <label><p>Color</p></label>
                <input type="text" name="color" value="<?php echo $get_color; ?>" readonly/>
            ...
            <div class="fneworder_dos">
                ...
                <?php
                require("../conexion.laialy.php");
                $consulta_de_proveedores = mysqli_query($conexion, "SELECT proveedor FROM proveedores WHERE id_proveedor='$consulta_insumo_bk_proveedor'");
                $listado_de_proveedores = mysqli_fetch_array($consulta_de_proveedores);                            
                $consulta_proveedor_nombre = utf8_encode($listado_de_proveedores['proveedor']);
                mysqli_close($conexion);
                ?>
                <input type="text" name="proveedor" value="<?php echo $consulta_proveedor_nombre; ?>" readonly/>
            </div>
        ...
        <?php      
            if (isset($_POST['submit'])){
                ...
                if ($form_valor !== $consulta_insumo_bk_valor){                    
                    ...
                    require("../conexion.laialy.php");
                    mysqli_query($conexion, "DELETE FROM $nav $where");
                                                                            
                    //////////////////////////////////////////REGISTRO LOG//////////////////////////////////////////////////
                    $log_accion = "Elimina Insumo USS N° ".$get_id_insumo." ID Insumo P ".$consulta_insumo_bk_id_insumo_p;
                    $log_valor = "Valor ".$consulta_insumo_bk_valor." Dolares";
                    require("log.php");
                    ////////////////////////////////////////////////////////////////////////////////////////////////////////
